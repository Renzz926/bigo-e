...
//  login password local session key(Encrypt)
export const PASSWORD_SESSION_ENCRYPTt_KEY = "PASSWORD__SESSION__ENCRYPTt__KEY";

// login rememberMe local session key
export const REMEMBER_ME_SESSION_CACHE_KEY = "REMEMBER_ME__SESSION__KEY";

// login account login token key
export const LOGIN_SESSION_CACHE_KEY = "Login__Token";

// userPlatformChooseType key
export const USER_PLATFORMTYPE_CHOOSE = "USER_PLATFORMTYPE_CHOOSE";
